...
To start hands-on lab session, first you should clone the https://github.com/rahmanusta/practicing-java9-module-system[repository] or download as zip file here https://github.com/rahmanusta/practicing-java9-module-system/archive/master.zip
